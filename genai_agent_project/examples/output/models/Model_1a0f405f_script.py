...
sphere.name = "Model_1a0f405f"

# Add a material
mat = bpy.data.materials.new(name="Model_1a0f405f_Material")
mat.use_nodes = True
...
texture = bpy.data.textures.new("Model_1a0f405f_Texture", type='NOISE')
...
armature.name = "Model_1a0f405f_Armature"
...
output = {
    "status": "success",
    "message": "Model 'Model_1a0f405f' created successfully",
    "objects_created": ["Model_1a0f405f", "Model_1a0f405f_Armature", "Camera", "Sun"],
    "model_description": "A red sphere with subdivision and displacement modifiers, rigged with a simple armature"
}

print("Generated model: Model_1a0f405f")
