...
sphere.name = "Model_5e7bed74"

# Add a material
mat = bpy.data.materials.new(name="Model_5e7bed74_Material")
mat.use_nodes = True
...
texture = bpy.data.textures.new("Model_5e7bed74_Texture", type='NOISE')
...
armature.name = "Model_5e7bed74_Armature"
...
output = {
    "status": "success",
    "message": "Model 'Model_5e7bed74' created successfully",
    "objects_created": ["Model_5e7bed74", "Model_5e7bed74_Armature", "Camera", "Sun"],
    "model_description": "A red sphere with subdivision and displacement modifiers, rigged with a simple armature"
}

print("Generated model: Model_5e7bed74")
