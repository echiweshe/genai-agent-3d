...
sphere.name = "Model_02c848a4"

# Add a material
mat = bpy.data.materials.new(name="Model_02c848a4_Material")
mat.use_nodes = True
...
texture = bpy.data.textures.new("Model_02c848a4_Texture", type='NOISE')
...
armature.name = "Model_02c848a4_Armature"
...
output = {
    "status": "success",
    "message": "Model 'Model_02c848a4' created successfully",
    "objects_created": ["Model_02c848a4", "Model_02c848a4_Armature", "Camera", "Sun"],
    "model_description": "A red sphere with subdivision and displacement modifiers, rigged with a simple armature"
}

print("Generated model: Model_02c848a4")
