...
sphere.name = "Model_53724903"

# Add a material
mat = bpy.data.materials.new(name="Model_53724903_Material")
mat.use_nodes = True
...
texture = bpy.data.textures.new("Model_53724903_Texture", type='NOISE')
...
armature.name = "Model_53724903_Armature"
...
output = {
    "status": "success",
    "message": "Model 'Model_53724903' created successfully",
    "objects_created": ["Model_53724903", "Model_53724903_Armature", "Camera", "Sun"],
    "model_description": "A red sphere with subdivision and displacement modifiers, rigged with a simple armature"
}

print("Generated model: Model_53724903")
