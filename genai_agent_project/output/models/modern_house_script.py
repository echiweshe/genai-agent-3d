# Fallback model script for: A small modern house with flat roof, large windows, and a minimalist design
# Style: architectural
# Name: modern_house
...
sphere.name = "modern_house"

# Add a material
mat = bpy.data.materials.new(name="modern_house_Material")
mat.use_nodes = True
...
texture = bpy.data.textures.new("modern_house_Texture", type='NOISE')
...
armature.name = "modern_house_Armature"
...
output = {
    "status": "success",
    "message": "Model 'modern_house' created successfully",
    "objects_created": ["modern_house", "modern_house_Armature", "Camera", "Sun"],
    "model_description": "A red sphere with subdivision and displacement modifiers, rigged with a simple armature"
}

print("Generated model: modern_house")
