# Fallback model script for: Create simple objects such as trees, grass, and mountains to populate the generated scene.
# Style: basic
# Name: Model_d95866f3
...
sphere.name = "Model_d95866f3"

# Add a material
mat = bpy.data.materials.new(name="Model_d95866f3_Material")
...
texture = bpy.data.textures.new("Model_d95866f3_Texture", type='NOISE')
...
armature.name = "Model_d95866f3_Armature"
...
print("Generated model: Model_d95866f3")
