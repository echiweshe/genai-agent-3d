...
sphere.name = "Model_fdd69eba"

# Add a material
mat = bpy.data.materials.new(name="Model_fdd69eba_Material")
mat.use_nodes = True
...
texture = bpy.data.textures.new("Model_fdd69eba_Texture", type='NOISE')
...
armature.name = "Model_fdd69eba_Armature"
...
output = {
    "status": "success",
    "message": "Model 'Model_fdd69eba' created successfully",
    "objects_created": ["Model_fdd69eba", "Model_fdd69eba_Armature", "Camera", "Sun"],
    "model_description": "A red sphere with subdivision and displacement modifiers, rigged with a simple armature"
}

print("Generated model: Model_fdd69eba")
