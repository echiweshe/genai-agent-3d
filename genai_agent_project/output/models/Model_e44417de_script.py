# Fallback model script for: Add a simple object like a cube or sphere to the scene.
# Style: basic
# Name: Model_e44417de
...
sphere.name = "Model_e44417de"

# Add a material
mat = bpy.data.materials.new(name="Model_e44417de_Material")
...
texture = bpy.data.textures.new("Model_e44417de_Texture", type='NOISE')
...
armature.name = "Model_e44417de_Armature"
...
print("Generated model: Model_e44417de")
