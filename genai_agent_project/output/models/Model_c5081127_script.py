...
sphere.name = "Model_c5081127"

# Add a material
mat = bpy.data.materials.new(name="Model_c5081127_Material")
...
texture = bpy.data.textures.new("Model_c5081127_Texture", type='NOISE')
...
armature.name = "Model_c5081127_Armature"
...
print("Generated model: Model_c5081127")
